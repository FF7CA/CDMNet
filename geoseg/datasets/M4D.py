...
data_path = r"/root/autodl-tmp/data/Oil Spill Detection Dataset"

CLASSES = ('SeaSurface', 'Oil', 'Lookalike', 'Ship', 'Land')

PALETTE = [[0, 0, 0], [255, 255, 0], [0, 0, 255], [0, 76, 153],
           [0, 153, 0]]
...
class M4DDataset(Dataset):
    def __init__(self, data_root=data_path, mode='val', img_dir='train_images', mask_dir='train_masks',
